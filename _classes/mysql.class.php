...
class MySQL
{
	...
	public $ThrowExceptions = true;
 	...
 	/**
	 * Defines de Timezone per session on server
	 *
	 * @var Timezone string
	 */
     ...
     *
     * @internal param array $valuesArray An array containing the column names.
	...
	*/
	...
	public function Open($database = null, $server = null, $username = null,
		...
		if (! $this->IsConnected()) {
            ...
            //$this->mysql_link->exec("SET time_zone = '" . $this->timezone . "'");
            @mysqli_query($this->mysql_link, "SET time_zone = '" . $this->timezone . "'");
